                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> 기간별 댓글 현황  
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="morris-area-chart">
                            	<form id="bnoChartForm" action="/chart/bno" method="get">
...
$(document).ready(function(){
	...
	$("#searchBtn").on("click", function(){
		...
		function drawChart() {
			  ...
			  var jsonData = $.ajax({
				  url: "/chart/rno?fromDate="+fromDate+"&toDate="+toDate,
				  dataType: "json",
				  async: false
			  }).responseText;
		      ...
		      var chart = new google.charts.Line(document.getElementById('rnoChart'));
